 ...
 */
export function getInstanceDetails(instance: any): any {
  return {
...
export function getInstanceState(instance: ComponentInternalInstance) {
...
function processState(instance: any): any {
...
function processAttrs(instance: any): any[] {
...
function processProvide(instance: any): any[] {
...
function processRefs(instance: ComponentInternalInstance): any[] {
...
function processEventListeners(instance: ComponentInternalInstance): any[] {
...
export function editState({ componentInstance, path, state, type }: any, stateEditor: any) {
...
function resolveMergedOptions(
  ...
  if (!globalMixins.length && !mixins && !extendsOptions)
    return raw
  const options = {}
  globalMixins.forEach((m: any) => mergeOptions(options, m, instance))
